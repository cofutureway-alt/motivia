...
export default function PaymentPaymobReturn() {
  ...
  // PayMob echoes special_reference (our reference_number) back on the redirection URL as
  // `merchant_order_id`. Also accept common fallbacks. We only USE this to look up our own
  // row; we never trust it to determine success.
  const reference =
      ...
      >
        <div className="p-8 space-y-6">
          <div className="flex items-center gap-2 text-xs text-muted-foreground">
            ...
            <span>عودة آمنة من بوابة PayMob</span>
          </div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground mt-2 leading-relaxed">
                    نتحقق من نتيجة عملية الدفع مع PayMob. عادةً ما يستغرق ذلك بضع ثوانٍ.
                  </div>
                </div>
            ...
            {state === "pending" && (
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground mt-2 leading-relaxed">
                    استلمنا عودتك من صفحة الدفع، لكن لم يصلنا تأكيد PayMob النهائي بعد.
            ...
            {state === "success" && txn && (
              ...
              >
                ...
                <SummaryBlock
                  ...
                  amount={amount}
                  icon={txn.purpose === "wallet_topup" ? WalletIcon : GraduationCap}
                />
                <div className="flex flex-col sm:flex-row gap-2">
                  {txn.purpose === "wallet_topup" ? (
                    ...
                    <Button
                      className="flex-1"
                      size="lg"
                      onClick={() => navigate(`/courses/${txn.course_id}`)}
                    >
                      فتح الدورة
                    </Button>
                  )}
  ...
  return (
    <div
      className={`rounded-2xl border p-4 text-right ${
        muted ? "border-border bg-accent/40" : "border-primary/20 bg-primary/5"
      }`}
    >
