...
import InstructorWithdrawals from "./pages/instructor/InstructorWithdrawals";
import InstructorLocations from "./pages/instructor/InstructorLocations";
import InstructorSettings from "./pages/instructor/InstructorSettings";
import AdminInstructors from "./pages/admin/AdminInstructors";
import AdminInstructorSettings from "./pages/admin/AdminInstructorSettings";
import AdminWithdrawals from "./pages/admin/AdminWithdrawals";
import AdminRevenueSettings from "./pages/admin/AdminRevenueSettings";
        ...
        <AuthProvider>
          ...
          <Routes>
            ...
            >
              ...
              <Route path="assignment-submissions" element={<InstructorAssignmentSubmissions />} />
              <Route path="earnings" element={<InstructorEarnings />} />
              <Route path="withdrawals" element={<InstructorWithdrawals />} />
              <Route path="locations" element={<InstructorLocations />} />
            ...
            >
              ...
              <Route path="instructors/:id" element={<AdminInstructorSettings />} />
              <Route path="withdrawals" element={<AdminWithdrawals />} />
              <Route path="revenue-settings" element={<AdminRevenueSettings />} />
